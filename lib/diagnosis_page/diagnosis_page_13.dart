...
class Diagnosis13 extends StatefulWidget {
  const Diagnosis13({super.key});

  @override
  State<Diagnosis13> createState() => _Diagnosis13State();
}

class _Diagnosis13State extends State<Diagnosis13> {
  @override
