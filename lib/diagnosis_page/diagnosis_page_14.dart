...
class Diagnosis14 extends StatefulWidget {
  const Diagnosis14({super.key});

  @override
  State<Diagnosis14> createState() => _Diagnosis14State();
}

class _Diagnosis14State extends State<Diagnosis14> {
  @override
