...
class Diagnosis03 extends StatefulWidget {
  const Diagnosis03({super.key});

  @override
  State<Diagnosis03> createState() => _Diagnosis03State();
}

class _Diagnosis03State extends State<Diagnosis03> {
  @override
