...
class Diagnosis06 extends StatefulWidget {
  const Diagnosis06({super.key});

  @override
  State<Diagnosis06> createState() => _Diagnosis06State();
}

class _Diagnosis06State extends State<Diagnosis06> {
  @override
