...
class Diagnosis05 extends StatefulWidget {
  const Diagnosis05({super.key});

  @override
  State<Diagnosis05> createState() => _Diagnosis05State();
}

class _Diagnosis05State extends State<Diagnosis05> {
  @override
