...
class Diagnosis04 extends StatefulWidget {
  const Diagnosis04({super.key});

  @override
  State<Diagnosis04> createState() => _Diagnosis04State();
}

class _Diagnosis04State extends State<Diagnosis04> {
  @override
